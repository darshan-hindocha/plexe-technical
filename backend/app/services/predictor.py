...
class PredictionService:
        ...
        try:
            ...
            if hasattr(model, 'predict_proba'):
                ...
                if len(proba) == 2:  # Binary classification
                    ...
                    probability = float(proba[prediction] if isinstance(prediction, (int, np.integer)) else max(proba))
    ...
    def predict_batch(self, model_id: str, features_list: List[Dict[str, Any]]) -> PredictionBatchResponse:
