    ...
    try:
        ...
        version_info = {
            ...
            "other_versions": [
                ...
                for m in model_family if m.id != model_id
            ]
        }
...
def find_model_by_name(model_name: str, latest_only: bool = True) -> dict:
    ...
    try:
        if latest_only:
            ...
            if latest_model:
                return {
                    ...
                    "model_type": latest_model.model_type.value if latest_model.model_type else "unknown",
        ...
        # Search all models
        models = model_registry.get_latest_models() if latest_only else model_registry.get_all_models()
        ...
        return {
            "found": False,
            "message": f"Error searching for model: {str(e)}"
        }
...
def get_model_versions(model_name: str) -> dict:
    ...
    try:
        ...
        return {
            "found": False,
            "message": f"Error getting model versions: {str(e)}"
        } 